...
|--------|---------------|
| [Interoperability Projects](https://github.com/NIH-NCPI/Interoperability-Projects) | Repository with files that briefly describe each interoperability project and links to their respective project repositories. <br/> **Repository Structure:** <br> - `Overview`: An overview table of the projects including brief descriptions <br> - `Projects`: Descriptions of the projects with links to their repositories |
